<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="HistorialEvaluaciones.aspx.cs" Inherits="Sistema_RRHH.HistorialEvaluaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-4">
        <h2>Detalle de Evaluaciones Completadas por Empleado</h2>
        ...
        <asp:LinkButton ID="lnkDescargarPdf" runat="server" CssClass="btn btn-danger"
            OnClick="lnkDescargarPdf_Click" ToolTip="Descargar PDF">
    <i class="fas fa-file-pdf"></i>
        </asp:LinkButton>

        <asp:LinkButton ID="lnkEliminarEvaluacion" runat="server" CssClass="btn btn-danger me-2"
            OnClick="lnkEliminarEvaluacion_Click" ToolTip="Eliminar Evaluación">
